...
public class ATM {
    ...
    // getters dos estados
    public ATMState getStateNoCard() { return stateNoCard; }
    public ATMState getStateWithCard() { return stateWithCard; }
    public ATMState getStateAuthenticated() { return stateAuthenticated; }
    public ATMState getStateNoMoney() { return stateNoMoney; }

    public ATMState getEstadoAtual() { return estadoAtual; }
    public void setEstadoAtual(ATMState estado) { this.estadoAtual = estado; }

    // Métodos delegados
    public void insertCard() { estadoAtual.insertCard(); }
    public void ejectCard() { estadoAtual.ejectCard(); }
    public void insertPIN(String pin) { estadoAtual.insertPIN(pin); }
    public void requestWithdraw(int valor) { estadoAtual.requestWithdraw(valor); }
